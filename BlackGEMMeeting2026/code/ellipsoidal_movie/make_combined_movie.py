...
ax.set_ylabel("Flux", fontsize=26, color=AXIS_CLR, labelpad=-30,
              fontproperties=inter)
...
ax.set_yticks([0.99, 0.995, 1.005, 1.01])
ax.set_yticklabels(["99%", "99.5%", "100.5%", "101%"], fontproperties=inter14, color=AXIS_CLR)
